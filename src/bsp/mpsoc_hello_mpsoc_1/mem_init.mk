...
# Memory: onchip_1
MEM_0 := nios_system_onchip_1
$(MEM_0)_NAME := onchip_1
...
$(MEM_0)_START := 0x10010000
$(MEM_0)_END := 0x1001ffff
$(MEM_0)_HIERARCHICAL_PATH := onchip_1
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: onchip_1
onchip_1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
