...
#define numberOfRows 260

unsigned int* imageAddress = (unsigned int*) (SDRAM_BASE + 4);

unsigned char grayed[imageHorizontal*imageVertical];
...
perf_print_formatted_report
 (P_COUNTER_BASE,
  ...
  float normalized_time = total_time / (imagesProcessed * imageHorizontal * numberOfRows);
